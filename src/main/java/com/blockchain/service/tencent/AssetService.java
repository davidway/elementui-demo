...
public interface AssetService {
	...
	AssetIssueDto issue(AssetIssueFormDto assetFormDto) throws Exception;
	...
	AssetIssueSubmitFormDto issueApply(AssetIssueFormDto assetFormDto) throws ServiceException, TrustSDKException, Exception;
