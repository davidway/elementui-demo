...
public class AssetSettleFormDto{
	...
	public String toString() {
		return "AssetSettleFormDto [amount=" + amount + ", ownerAccount="
				+ ownerAccount + ", userPrivateKey=" + userPrivateKey
				+ ", srcAsset=" + srcAsset + ", ownerPublickey="
				+ ownerPublickey + ", ownerId=" + ownerId + ", nonce=" + nonce
				+ ", gasPrice=" + gasPrice + ", gasLimit=" + gasLimit
				+ ", offlineFile=" + offlineFile + ", password=" + password
				+ "]";
	}
