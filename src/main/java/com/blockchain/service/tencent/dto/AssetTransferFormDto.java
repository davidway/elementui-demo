...
public class AssetTransferFormDto {
	...
	@Min(value = 1, message = "金额必须大于0,而且为整数，最大数字为1后13个0 ")
	...
	public String toString() {
		return "AssetTransferFormDto [amount=" + amount + ", srcAccount="
				+ srcAccount + ", dstAccount=" + dstAccount + ", srcAsset="
				+ srcAsset + ", feeAccount=" + feeAccount + ", feeAmount="
				+ feeAmount + ", userPrivateKey=" + userPrivateKey
				+ ", dstAccountPublicKey=" + dstAccountPublicKey
				+ ", srcAccountPublicKey=" + srcAccountPublicKey
				+ ", feeAccountPublicKey=" + feeAccountPublicKey
				+ ", feeAccountUid=" + feeAccountUid + ", dstAccountUid="
				+ dstAccountUid + ", srcAccountUid=" + srcAccountUid
				+ ", nonce=" + nonce + ", gasPrice=" + gasPrice + ", gasLimit="
				+ gasLimit + ", keyStore=" + keyStore + ", password="
				+ password + "]";
	}
